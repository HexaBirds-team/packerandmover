      ...
      <Container className="py-5 my-4">
        <Row className=" justify-content-between">
          <Col xs={12} xl={8}>
            ...
            <h3
              className=" ff_rufina fs_xl fw_regular text_primary pt-5"
              data-aos="fade-up"
              data-aos-duration="700"
              data-aos-offset="200"
              data-aos-delay="300"
            ...
            <p
              className=" ff_opensans fs_md fw_regular text_dark py-3"
              data-aos="fade-up"
              data-aos-duration="700"
              data-aos-offset="200"
              data-aos-delay="500"
            ...
            <Row className=" pt-4">
              ...
              <Col xs={12} lg={8} className="pt-4 pt-lg-0">
                <h2
                  className=" ff_rufina fs_3xl fw_bold text_dark"
                  data-aos="fade-up"
                  data-aos-duration="700"
                  data-aos-offset="200"
                  data-aos-delay="100"
                ...
                <p
                  className=" ff_opensans fs_md fw_regular text_dark pt-3"
                  data-aos="fade-up"
                  data-aos-duration="700"
                  data-aos-offset="200"
                  data-aos-delay="200"
                ...
                <p
                  className=" ff_opensans fs_md fw_regular text_dark py-lg-3"
                  data-aos="fade-up"
                  data-aos-duration="700"
                  data-aos-offset="200"
                  data-aos-delay="300"
          ...
          <Col xs={12} xl={4} xxl={3} className="pt-5 pt-xl-0">
            ...
            <div
              className="bgimage_Book_Appointment py-5 text-center mt-5"
              data-aos="fade-up"
              data-aos-duration="700"
              data-aos-offset="200"
              data-aos-delay="100"
