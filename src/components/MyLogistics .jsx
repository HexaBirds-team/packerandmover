      ...
      <div className=" bg_light">
        <Container className="py-5 my-xl-5">
          <div className="text-center">
            <h2
              className="ff_rufina fs_4xl fw_regular text_primary "
              data-aos="zoom-in"
              data-aos-duration="700"
              data-aos-offset="200"
            >
              We provide the best suggestions for
              <span className="text_secondary px-2">
          ...
          <Row className="pt-5 justify-content-between">
            <Col xs={12} lg={7} xl={6}>
              <h2
                className="ff_rufina fs_5xl fw_bold text_primary"
                data-aos="fade-down "
                data-aos-duration="700"
                data-aos-offset="200"
              >
              ...
              <h3
                className="ff_rufina fw_bold fs_3xl text_secondary"
                data-aos="fade-right"
                data-aos-duration="700"
                data-aos-offset="200"
              >
              ...
              <p
                className="ff_opensans fs_md fw_regular text_dark mb-0 pt-3 pe-xl-5 me-xl-3"
                data-aos="fade-up"
                data-aos-duration="700"
                data-aos-offset="200"
              >
              ...
              <p
                className="ff_opensans fs_md fw_regular text_dark pe-xl-5 me-xl-3"
                data-aos="fade-up"
                data-aos-duration="700"
                data-aos-offset="200"
              >
