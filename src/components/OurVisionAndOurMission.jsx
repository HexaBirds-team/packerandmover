  ...
  return (
    <>
      <Container className="py-5 my-4">
        <Row>
          <Col xs={12} md={6}>
            <h2 className=" ff_rufina fw_bold fs_7xl textpr">
              Our <span className=" text_secondary">Vision</span>
            </h2>
            <h3 className=" ff_rufina fs_2xl fw_regular text_primary py-2 py-lg-4">
              Lorem Ipsum is simply my text of the printing and Ipsum is the
              Ipsum is simply.
            </h3>
            <p className=" ff_opensans fw_regular fs_md text_dark">
              Lorem Ipsum is simply my text of the printing and Ipsum is the
          ...
          <Col xs={12} md={6} className="pt-4 pt-md-0">
            ...
            <h3 className=" ff_rufina fs_2xl fw_regular text_primary py-md-2 py-lg-4">
              Lorem Ipsum is simply my text of the printing and Ipsum is the
              Ipsum is simply.
            </h3>
            <p className=" ff_opensans fw_regular fs_md text_dark">
